...
namespace WebService.Application.Interfaces
{
    public interface IRepository<TEntity> where TEntity : BaseEntity
    {
        ...
        Task<int> DeleteAsync(TEntity entity, bool isDeleted = false);
        int Delete(TEntity entity);
        Task<int> DeleteAsync(long id, bool isDeleted = false);
        int Delete(long id);
        ...
        Task<TEntity> GetByIdAsync(long id, bool noTracking = true, params Expression<Func<TEntity, object>>[] includes);
        ...
        Task BulkDeleteById(IEnumerable<long> ids);
